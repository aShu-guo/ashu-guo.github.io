import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const i="/imgs/base/git-commit.gif",l="/imgs/base/git-reset.gif",c={},t=e(`<h1 id="仓库相关操作" tabindex="-1"><a class="header-anchor" href="#仓库相关操作" aria-hidden="true">#</a> 仓库相关操作</h1><h2 id="基础操作" tabindex="-1"><a class="header-anchor" href="#基础操作" aria-hidden="true">#</a> 基础操作</h2><h3 id="变动代码提交" tabindex="-1"><a class="header-anchor" href="#变动代码提交" aria-hidden="true">#</a> 变动代码提交</h3><blockquote><p>git仓库分为4个部分：工作区 -&gt; 暂存区 -&gt; 本地仓库 -&gt; 远程仓库</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 将变动代码提交到暂存区</span>
