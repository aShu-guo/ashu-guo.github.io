import{_ as n,p as a,q as s,a1 as e}from"./framework-96b046e1.js";const i="/imgs/base/git-checkout-b.png",c="/imgs/base/merge-animation.gif",l={},t=e(`<h1 id="分支基础操作" tabindex="-1"><a class="header-anchor" href="#分支基础操作" aria-hidden="true">#</a> 分支基础操作</h1><p>切记：在进行分支操作之前都必须保持分支上的代码是最新的，意味着每次操作分支之前都必须pull一次</p><h2 id="查看分支" tabindex="-1"><a class="header-anchor" href="#查看分支" aria-hidden="true">#</a> 查看分支</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看所有远程分支</span>
