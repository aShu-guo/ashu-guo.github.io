import{_ as n,p as s,q as a,a1 as e}from"./framework-1443a5b1.js";const l={},o=e(`<blockquote><h4 id="三目表达式" tabindex="-1"><a class="header-anchor" href="#三目表达式" aria-hidden="true">#</a> 三目表达式</h4></blockquote><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> a
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),t=[o];function i(p,c){return s(),a("div",null,t)}const d=n(l,[["render",i],["__file","空值容错.html.vue"]]);export{d as default};
