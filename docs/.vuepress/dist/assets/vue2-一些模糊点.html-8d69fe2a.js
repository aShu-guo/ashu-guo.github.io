import{_ as p,M as t,p as e,q as o,R as l,t as c,N as i,a1 as n}from"./framework-1443a5b1.js";const r={},u=n(`<blockquote><h3 id="api上的模糊点" tabindex="-1"><a class="header-anchor" href="#api上的模糊点" aria-hidden="true">#</a> API上的模糊点</h3></blockquote><p>1.Vue.extend</p><p>用来新建一个组件构造器</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//首先通过新建一个组件构造器</span>
